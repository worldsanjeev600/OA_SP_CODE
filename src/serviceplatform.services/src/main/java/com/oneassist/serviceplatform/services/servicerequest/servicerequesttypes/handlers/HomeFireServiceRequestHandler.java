...
@Component
public class HomeFireServiceRequestHandler extends BaseWHCServiceTypeHandler {

	private final Logger logger = Logger.getLogger(HomeFireServiceRequestHandler.class);

	public HomeFireServiceRequestHandler() {
		super(ServiceRequestType.HA_FR);
	}
	...
	public ServiceRequestDto updateServiceRequest(ServiceRequestDto serviceRequestDto,
		...
		serviceRequestDto.setStatus(newServiceRequestEntity.getStatus());
		serviceRequestDto.setServiceRequestId(newServiceRequestEntity.getServiceRequestId());
