...
@Component
public class SRDataNotificationManager extends DataNotificationManager<ServiceRequestDto> {

    private static final Logger logger = LoggerFactory.getLogger(SRDataNotificationManager.class);
