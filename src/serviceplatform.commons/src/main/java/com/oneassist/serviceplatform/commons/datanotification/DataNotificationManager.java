 ...
 *         </p>
 */
public abstract class DataNotificationManager<T> implements Runnable {

    private static final Logger logger = LoggerFactory.getLogger(DataNotificationManager.class);
    ...
    @Value("${SP_DATA_NOTIFICATION_QUEUE_NAME}")
